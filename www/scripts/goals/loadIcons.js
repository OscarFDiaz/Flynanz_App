function loadIconsGoal() {
  ...
  for (let i = 0; i < artNames.length; i++) {
    if (i == 0) {
      iconsView.innerHTML += `<img src="${art}${artNames[i]}" style="width: 80%; margin: auto auto; grid-column: 1;" onclick="selectIconGoal('${artNames[i]}', '${art}')"></img>`;
    } else {
      iconsView.innerHTML += `<img src="${art}${artNames[i]}" style="width: 80%; margin: auto auto;" onclick="selectIconGoal('${artNames[i]}', '${art}')"></img>`;
    }
  }
  ...
  for (let i = 0; i < bookNames.length; i++) {
    if (i == 0) {
      iconsView.innerHTML += `<img src="${book}${bookNames[i]}" style="width: 80%; margin: auto auto; grid-column: 1;" onclick="selectIconGoal('${bookNames[i]}', '${book}')"></img>`;
    } else {
      iconsView.innerHTML += `<img src="${book}${bookNames[i]}" style="width: 80%; margin: auto auto;" onclick="selectIconGoal('${bookNames[i]}', '${book}')"></img>`;
    }
  }
  ...
  for (let i = 0; i < buildsNames.length; i++) {
    if (i == 0) {
      iconsView.innerHTML += `<img src="${builds}${buildsNames[i]}" style="width: 80%; margin: auto auto; grid-column: 1;" onclick="selectIconGoal('${buildsNames[i]}', '${builds}')"></img>`;
    } else {
      iconsView.innerHTML += `<img src="${builds}${buildsNames[i]}" style="width: 80%; margin: auto auto;" onclick="selectIconGoal('${buildsNames[i]}', '${builds}')"></img>`;
    }
  }
  ...
  for (let i = 0; i < cameraNames.length; i++) {
    if (i == 0) {
      iconsView.innerHTML += `<img src="${camera}${cameraNames[i]}" style="width: 80%; margin: auto auto; grid-column: 1;" onclick="selectIconGoal('${cameraNames[i]}', '${camera}')"></img>`;
    } else {
      iconsView.innerHTML += `<img src="${camera}${cameraNames[i]}" style="width: 80%; margin: auto auto;" onclick="selectIconGoal('${cameraNames[i]}', '${camera}')"></img>`;
    }
  }
  ...
  for (let i = 0; i < fixNames.length; i++) {
    if (i == 0) {
      iconsView.innerHTML += `<img src="${fix}${fixNames[i]}" style="width: 80%; margin: auto auto; grid-column: 1;" onclick="selectIconGoal('${fixNames[i]}', '${fix}')"></img>`;
    } else {
      iconsView.innerHTML += `<img src="${fix}${fixNames[i]}" style="width: 80%; margin: auto auto;" onclick="selectIconGoal('${fixNames[i]}', '${fix}')"></img>`;
    }
  }
