function loadIcons() {
  ...
  for (let i = 0; i < artNames.length; i++) {
    if (i == 0) {
      iconsView.innerHTML += `<img src="${art}${artNames[i]}" style="width: 55%; margin: auto auto; grid-column: 1;" onclick="selectIcon('${artNames[i]}', '${art}')"></img>`;
    } else {
      iconsView.innerHTML += `<img src="${art}${artNames[i]}" style="width: 55%; margin: auto auto;" onclick="selectIcon('${artNames[i]}', '${art}')"></img>`;
    }
  }
  ...
  for (let i = 0; i < bookNames.length; i++) {
    if (i == 0) {
      iconsView.innerHTML += `<img src="${book}${bookNames[i]}" style="width: 55%; margin: auto auto; grid-column: 1;" onclick="selectIcon('${bookNames[i]}', '${book}')"></img>`;
    } else {
      iconsView.innerHTML += `<img src="${book}${bookNames[i]}" style="width: 55%; margin: auto auto;" onclick="selectIcon('${bookNames[i]}', '${book}')"></img>`;
    }
  }
  ...
  for (let i = 0; i < buildsNames.length; i++) {
    if (i == 0) {
      iconsView.innerHTML += `<img src="${builds}${buildsNames[i]}" style="width: 55%; margin: auto auto; grid-column: 1;" onclick="selectIcon('${buildsNames[i]}', '${builds}')"></img>`;
    } else {
      iconsView.innerHTML += `<img src="${builds}${buildsNames[i]}" style="width: 55%; margin: auto auto;" onclick="selectIcon('${buildsNames[i]}', '${builds}')"></img>`;
    }
  }
  ...
  for (let i = 0; i < cameraNames.length; i++) {
    if (i == 0) {
      iconsView.innerHTML += `<img src="${camera}${cameraNames[i]}" style="width: 55%; margin: auto auto; grid-column: 1;" onclick="selectIcon('${cameraNames[i]}', '${camera}')"></img>`;
    } else {
      iconsView.innerHTML += `<img src="${camera}${cameraNames[i]}" style="width: 55%; margin: auto auto;" onclick="selectIcon('${cameraNames[i]}', '${camera}')"></img>`;
    }
  }
  ...
  for (let i = 0; i < fixNames.length; i++) {
    if (i == 0) {
      iconsView.innerHTML += `<img src="${fix}${fixNames[i]}" style="width: 55%; margin: auto auto; grid-column: 1;" onclick="selectIcon('${fixNames[i]}', '${fix}')"></img>`;
    } else {
      iconsView.innerHTML += `<img src="${fix}${fixNames[i]}" style="width: 55%; margin: auto auto;" onclick="selectIcon('${fixNames[i]}', '${fix}')"></img>`;
    }
  }
